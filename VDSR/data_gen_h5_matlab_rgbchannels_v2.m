    ...
    for scale=2:4
        ...
        for x = 1:stride:h1-image_size+1
            for y = 1:stride:w1-image_size+1
                ...
                subimg_r_label = img_r_label(x:x+label_size-1, y:y+label_size-1);
                subimg_g_input = img_g_input(x:x+image_size-1, y:y+image_size-1);
                subimg_g_label = img_g_label(x:x+label_size-1, y:y+label_size-1);
                subimg_b_input = img_b_input(x:x+image_size-1, y:y+image_size-1);
                subimg_b_label = img_b_label(x:x+label_size-1, y:y+label_size-1);
